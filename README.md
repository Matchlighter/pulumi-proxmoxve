...
First, clone this repo with the name of the desired provider in place of `proxmoxve`:

```
git clone https://github.com/pulumi/pulumi-tf-provider-boilerplate pulumi-proxmoxve
```

Second, replace references to `proxmoxve` with the name of your provider:
